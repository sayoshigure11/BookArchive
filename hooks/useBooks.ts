...
// // useContextみたいにグローバル化してるっぽい。いったん普通のエクスポートに変えてみて、複数箇所で呼ばれていたら考える。
// // https://www.npmjs.com/package/@nkzw/create-context-hook
// export const [BookContext, useBooks] = createContextHook(() => {
...
//         await localStorage.setItem(STORAGE_KEY, JSON.stringify(INITIAL_BOOKS));
//       }
//     } catch (error) {
...
//       await localStorage.setItem(STORAGE_KEY, JSON.stringify(newBooks));
//       setBooks(newBooks);
//     } catch (error) {
